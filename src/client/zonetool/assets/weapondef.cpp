...
#define WEAPON_READ_SOUND(__field__) \
	...
	WeaponDef* IWeaponDef::parse(const std::string& name, ZoneMemory* mem)
	{
		...
		WEAPON_READ_FIELD(int, iAmmoCounterClip);
		...
		WEAPON_READ_FIELD(int, iMinAmmoReq);
		...
		WEAPON_READ_FIELD(float, fAdsSceneBlur);
		...
		WEAPON_READ_FIELD(float, fHipSpreadStandMax);
		//WEAPON_READ_FIELD(float, xU_009);
		//WEAPON_READ_FIELD(float, xU_010);
		WEAPON_READ_FIELD(float, fHipSpreadDuckedMax);
		WEAPON_READ_FIELD(float, fHipSpreadProneMax);
		...
		WEAPON_READ_FIELD(float, fAdsIdleSpeed);
		WEAPON_READ_FIELD(float, fHipIdleSpeed);
		...
		WEAPON_READ_FIELD_ARR(float, vProjectileColor, 3);
		...
		WEAPON_READ_FIELD(float, fAdsViewKickMagMin);
		...
		WEAPON_READ_FIELD(int, iAmmoUsedPerShot);
...
#define WEAPON_DUMP_SOUND(__field__) \
	...
	void IWeaponDef::dump(WeaponDef* asset)
	{
		...
		WEAPON_DUMP_FIELD(fAdsSceneBlur);
		...
		WEAPON_DUMP_FIELD(fHipSpreadStandMax);
		//WEAPON_DUMP_FIELD(xU_009);
		//WEAPON_DUMP_FIELD(xU_010);
		WEAPON_DUMP_FIELD(fHipSpreadDuckedMax);
		WEAPON_DUMP_FIELD(fHipSpreadProneMax);
		...
		WEAPON_DUMP_FIELD(fAdsIdleSpeed);
		WEAPON_DUMP_FIELD(fHipIdleSpeed);
